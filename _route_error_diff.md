...
- generatedAt: 2026-06-23T07:38:44.124Z
- totalErrorRoutes: 162
...
- GET /api/v1/admin/admin/city/:cityId/doctors -> controller/adminController.js#getDoctorsByCity | status=400 | category=validation
  ...
  reproducibility: GET /api/v1/admin/admin/city/6a02f3dea924e2b2a433f288/doctors using context=admin
- GET /api/v1/admin/admin/doctor/:doctorId/cities -> controller/adminController.js#getDoctorCities | status=404 | category=not-found
  error: Doctor not found
  reproducibility: GET /api/v1/admin/admin/doctor/507f1f77bcf86cd799439011/cities using context=admin
- POST /api/v1/admin/admin/doctor/add-cities -> controller/adminController.js#addDoctorToCities | status=404 | category=not-found
  error: Doctor not found
  reproducibility: POST /api/v1/admin/admin/doctor/add-cities using context=admin
- POST /api/v1/admin/admin/doctor/remove-cities -> controller/adminController.js#removeDoctorFromCities | status=404 | category=not-found
  error: Doctor not found
  reproducibility: POST /api/v1/admin/admin/doctor/remove-cities using context=admin
- PUT /api/v1/admin/admin/doctor/update-cities -> controller/adminController.js#updateDoctorCities | status=404 | category=not-found
  error: Doctor not found
...
- DELETE /api/v1/admin/doctors/:id -> controller/adminController.js#deleteDoctor | status=404 | category=not-found
  error: Doctor not found
  reproducibility: DELETE /api/v1/admin/doctors/507f1f77bcf86cd799439011 using context=admin
- GET /api/v1/admin/doctors/:id -> controller/adminController.js#getDoctorById | status=404 | category=not-found
  error: Doctor not found
  reproducibility: GET /api/v1/admin/doctors/507f1f77bcf86cd799439011 using context=admin
- PUT /api/v1/admin/doctors/:id/approve -> controller/adminController.js#approveDoctor | status=404 | category=not-found
  error: Doctor not found
  reproducibility: PUT /api/v1/admin/doctors/507f1f77bcf86cd799439011/approve using context=admin
- PUT /api/v1/admin/doctors/:id/reject -> controller/adminController.js#rejectDoctor | status=404 | category=not-found
  error: Doctor not found
  reproducibility: PUT /api/v1/admin/doctors/507f1f77bcf86cd799439011/reject using context=admin
- PATCH /api/v1/admin/doctors/:id/toggle-status -> controller/adminController.js#toggleDoctorStatus | status=404 | category=not-found
  error: Doctor not found
  reproducibility: PATCH /api/v1/admin/doctors/507f1f77bcf86cd799439011/toggle-status using context=admin
- PATCH /api/v1/admin/doctors/:id/verification-review -> controller/doctorVerificationController.js#reviewDoctorVerification | status=404 | category=not-found
  error: Doctor not found
  reproducibility: PATCH /api/v1/admin/doctors/507f1f77bcf86cd799439011/verification-review using context=admin
...
- DELETE /api/v1/admin/patient/:patientId/medications -> controller/adminController.js#adminRemoveMedication | status=404 | category=not-found
  error: Medication not found in patient's list
  reproducibility: DELETE /api/v1/admin/patient/6a031fdc05fb2370df312436/medications?medication=Paracetamol using context=admin
- GET /api/v1/admin/patients/:id -> controller/adminController.js#getPatientById | status=404 | category=not-found
  error: Patient not found
  reproducibility: GET /api/v1/admin/patients/6a031fdc05fb2370df312436 using context=admin
- PUT /api/v1/admin/patients/:id/block -> controller/adminController.js#blockPatient | status=404 | category=not-found
  error: Patient not found
  reproducibility: PUT /api/v1/admin/patients/6a031fdc05fb2370df312436/block using context=admin
- PATCH /api/v1/admin/patients/:id/toggle-status -> controller/adminController.js#togglePatientStatus | status=404 | category=not-found
  error: Patient not found
  reproducibility: PATCH /api/v1/admin/patients/6a031fdc05fb2370df312436/toggle-status using context=admin
- GET /api/v1/admin/patients/:patientId/treatments -> controller/adminController.js#getPatientTreatmentsForBooking | status=404 | category=not-found
  error: Patient not found
  reproducibility: GET /api/v1/admin/patients/6a031fdc05fb2370df312436/treatments using context=admin
...
- PATCH /api/v1/admin/payments/settlements/:id -> controller/adminPaymentController.js#updateSettlementStatus | status=404 | category=not-found
  ...
  reproducibility: PATCH /api/v1/admin/payments/settlements/6a03391356ea778474f53492 using context=admin
...
- POST /api/v1/admin/payments/treatments/:treatmentId/manual-collection -> controller/adminPaymentController.js#adminManualCollection | status=400 | category=validation
  error: Amount exceeds the remaining treatment balance
  reproducibility: POST /api/v1/admin/payments/treatments/6a38e2ff05494ed2c91e6d9c/manual-collection using context=admin
...
- PATCH /api/v1/admin/reviews/:id/moderation -> controller/reviewController.js#moderateReview | status=404 | category=not-found
  ...
  reproducibility: PATCH /api/v1/admin/reviews/6a03391356ea778474f53492/moderation using context=admin
...
- DELETE /api/v1/admin/subadmins/:id -> controller/adminController.js#deleteSubAdmin | status=404 | category=not-found
  ...
  reproducibility: DELETE /api/v1/admin/subadmins/6a03391356ea778474f53492 using context=admin
- GET /api/v1/admin/subadmins/:id -> controller/adminController.js#getSubAdminById | status=404 | category=not-found
  error: Admin not found
  reproducibility: GET /api/v1/admin/subadmins/6a03391356ea778474f53492 using context=admin
- PATCH /api/v1/admin/subadmins/:id -> controller/adminController.js#updateSubAdmin | status=404 | category=not-found
  error: Admin not found
  reproducibility: PATCH /api/v1/admin/subadmins/6a03391356ea778474f53492 using context=admin
- POST /api/v1/admin/subadmins/:id/force-logout -> controller/adminGovernanceController.js#forceLogoutSubAdmin | status=404 | category=not-found
  error: Admin not found
  reproducibility: POST /api/v1/admin/subadmins/6a03391356ea778474f53492/force-logout using context=admin
- PATCH /api/v1/admin/subadmins/:id/toggle-status -> controller/adminController.js#toggleSubAdminStatus | status=404 | category=not-found
  error: Admin not found
  reproducibility: PATCH /api/v1/admin/subadmins/6a03391356ea778474f53492/toggle-status using context=admin
- PATCH /api/v1/admin/support/tickets/:id -> controller/supportController.js#updateTicket | status=404 | category=not-found
  error: Support ticket not found
  reproducibility: PATCH /api/v1/admin/support/tickets/6a03391356ea778474f53492 using context=admin
...
- DELETE /api/v1/article/:id -> unknown | status=403 | category=auth
  error: Access denied. Allowed roles: doctor, hospital
  reproducibility: DELETE /api/v1/article/69ff98563dfe2cc4bfac8153 using context=admin
- PATCH /api/v1/article/:id/publish -> unknown | status=403 | category=auth
  error: Access denied. Allowed roles: doctor, hospital
  reproducibility: PATCH /api/v1/article/69ff98563dfe2cc4bfac8153/publish using context=admin
- POST /api/v1/article/create -> unknown | status=403 | category=auth
  error: Access denied. Allowed roles: doctor, hospital
  reproducibility: POST /api/v1/article/create using context=admin
- GET /api/v1/article/my-articles -> unknown | status=403 | category=auth
  error: Access denied. Allowed roles: doctor, hospital
  reproducibility: GET /api/v1/article/my-articles using context=admin
- PUT /api/v1/article/updateArticle/:id -> unknown | status=403 | category=auth
  error: Access denied. Allowed roles: doctor, hospital
  reproducibility: PUT /api/v1/article/updateArticle/69ff98563dfe2cc4bfac8153 using context=admin
...
- GET /api/v1/booking/patient/:treatmentId -> controller/bookingController.js#getTreatmentById | status=403 | category=auth
  ...
  reproducibility: GET /api/v1/booking/patient/6a38e2ff05494ed2c91e6d9c using context=admin
...
- PUT /api/v1/city/admin/cities/:cityId -> controller/cityController.js#updateCity | status=404 | category=not-found
  ...
  reproducibility: PUT /api/v1/city/admin/cities/6a02f3dea924e2b2a433f288 using context=admin
- PATCH /api/v1/city/admin/cities/toggle/:cityId -> controller/cityController.js#toggleCityStatus | status=404 | category=not-found
  error: City not found
  reproducibility: PATCH /api/v1/city/admin/cities/toggle/6a02f3dea924e2b2a433f288 using context=admin
- GET /api/v1/city/cities/:cityId -> controller/cityController.js#getCityById | status=404 | category=not-found
  error: City not found
  reproducibility: GET /api/v1/city/cities/6a02f3dea924e2b2a433f288 using context=public
...
- PUT /api/v1/doctor-appointments/:appointmentId/reschedule -> controller/doctorAppointmentController.js#rescheduleDoctorAppointment | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: PUT /api/v1/doctor-appointments/:appointmentId/reschedule using context=admin
- PATCH /api/v1/doctor-appointments/:appointmentId/status -> controller/doctorAppointmentController.js#updateDoctorAppointmentStatus | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: PATCH /api/v1/doctor-appointments/:appointmentId/status using context=admin
...
- GET /api/v1/doctor-appointments/doctor/my-appointments -> controller/doctorAppointmentController.js#getMyDoctorAppointments | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: GET /api/v1/doctor-appointments/doctor/my-appointments using context=admin
- GET /api/v1/doctor/:doctorId/service-availability -> controller/doctorController.js#getServiceAvailability | status=404 | category=not-found
  error: Doctor not found
  reproducibility: GET /api/v1/doctor/507f1f77bcf86cd799439011/service-availability using context=public
- GET /api/v1/doctor/:id/public-profile -> controller/doctorDiscoveryController.js#getPublicProfile | status=404 | category=not-found
  error: Doctor not found
  reproducibility: GET /api/v1/doctor/6a03391356ea778474f53492/public-profile using context=public
- POST /api/v1/doctor/addClinic -> controller/doctorController.js#addClinic | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: POST /api/v1/doctor/addClinic using context=admin
- POST /api/v1/doctor/availability -> controller/doctorController.js#configureAvailability | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: POST /api/v1/doctor/availability using context=admin
- PUT /api/v1/doctor/availability -> controller/doctorController.js#updateAvailability | status=404 | category=not-found
  error: Doctor not found
  reproducibility: PUT /api/v1/doctor/availability using context=admin
- DELETE /api/v1/doctor/break-time -> controller/doctorController.js#removeBreakTime | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: DELETE /api/v1/doctor/break-time using context=admin
- POST /api/v1/doctor/break-time -> controller/doctorController.js#addBreakTime | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: POST /api/v1/doctor/break-time using context=admin
- PUT /api/v1/doctor/bulk-manage-slots -> controller/doctorController.js#bulkManageSlots | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: PUT /api/v1/doctor/bulk-manage-slots using context=admin
- POST /api/v1/doctor/clinic -> controller/doctorController.js#addClinic | status=400 | category=validation
  ...
  reproducibility: POST /api/v1/doctor/clinic using context=admin
- DELETE /api/v1/doctor/clinic/:clinicId -> controller/doctorController.js#deleteClinic | status=404 | category=not-found
  error: Doctor not found
  reproducibility: DELETE /api/v1/doctor/clinic/507f1f77bcf86cd799439016 using context=admin
- PUT /api/v1/doctor/clinic/:clinicId -> controller/doctorController.js#updateClinic | status=404 | category=not-found
  error: Doctor not found
  reproducibility: PUT /api/v1/doctor/clinic/507f1f77bcf86cd799439016 using context=admin
- DELETE /api/v1/doctor/deleteClinic/:clinicId -> controller/doctorController.js#deleteClinic | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: DELETE /api/v1/doctor/deleteClinic/507f1f77bcf86cd799439016 using context=admin
- GET /api/v1/doctor/doctor/cities/by-name/:doctorId/:cityName -> controller/doctorController.js#getDoctorCitiesByName | status=404 | category=not-found
  error: Doctor not found
  reproducibility: GET /api/v1/doctor/doctor/cities/by-name/507f1f77bcf86cd799439011/Lucknow using context=public
- GET /api/v1/doctor/doctor/my-cities/:doctorId -> controller/doctorController.js#getDoctorCities | status=404 | category=not-found
  error: Doctor not found
  reproducibility: GET /api/v1/doctor/doctor/my-cities/507f1f77bcf86cd799439011 using context=public
- GET /api/v1/doctor/getAllClinics -> controller/doctorController.js#getAllClinics | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: GET /api/v1/doctor/getAllClinics using context=admin
- GET /api/v1/doctor/getClinicById/:clinicId -> controller/doctorController.js#getClinicById | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: GET /api/v1/doctor/getClinicById/507f1f77bcf86cd799439016 using context=admin
- GET /api/v1/doctor/getDoctorById/:id -> controller/doctorController.js#getDoctorById | status=404 | category=not-found
  error: Doctor not found
  reproducibility: GET /api/v1/doctor/getDoctorById/6a03391356ea778474f53492 using context=public
- GET /api/v1/doctor/getMyProfile -> controller/doctorController.js#getMyProfile | status=404 | category=not-found
  error: Doctor not found
  reproducibility: GET /api/v1/doctor/getMyProfile using context=admin
- POST /api/v1/doctor/login -> controller/doctorController.js#doctorLogin | status=400 | category=validation
  error: Phone number is required
  reproducibility: POST /api/v1/doctor/login using context=public
...
- GET /api/v1/doctor/my-availability -> controller/doctorController.js#getMyAvailability | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: GET /api/v1/doctor/my-availability using context=admin
...
- PUT /api/v1/doctor/service-availability -> controller/doctorController.js#updateServiceAvailability | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: PUT /api/v1/doctor/service-availability using context=admin
- PUT /api/v1/doctor/service-coverage -> controller/doctorController.js#updateServiceCoverage | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: PUT /api/v1/doctor/service-coverage using context=admin
...
- GET /api/v1/doctor/slots/:doctorId -> controller/doctorController.js#getAvailableSlots | status=404 | category=not-found
  error: Doctor not found
  reproducibility: GET /api/v1/doctor/slots/507f1f77bcf86cd799439011?date=2026-05-09 using context=public
- PUT /api/v1/doctor/toggle-slot -> controller/doctorController.js#toggleSlotAvailability | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: PUT /api/v1/doctor/toggle-slot using context=admin
- PUT /api/v1/doctor/updateClinic/:clinicId -> controller/doctorController.js#updateClinic | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: PUT /api/v1/doctor/updateClinic/507f1f77bcf86cd799439016 using context=admin
- PUT /api/v1/doctor/updateProfile -> controller/doctorController.js#updateProfile | status=404 | category=not-found
  error: Doctor not found
  reproducibility: PUT /api/v1/doctor/updateProfile using context=admin
- POST /api/v1/doctor/verification-documents -> controller/doctorVerificationController.js#uploadVerificationDocuments | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: POST /api/v1/doctor/verification-documents using context=admin
- POST /api/v1/doctor/verification/submit -> controller/doctorVerificationController.js#submitVerification | status=403 | category=auth
  error: Access denied. Allowed roles: doctor
  reproducibility: POST /api/v1/doctor/verification/submit using context=admin
...
- GET /api/v1/items/getItemCategoryById/:id -> controller/itemCategoryController.js#getItemsByCategory | status=404 | category=not-found
  error: Category 6a03391356ea778474f53492 not found or deleted
  reproducibility: GET /api/v1/items/getItemCategoryById/6a03391356ea778474f53492 using context=public
- PATCH /api/v1/items/toggle-status/:id -> controller/itemCategoryController.js#toggleCategoryStatus | status=404 | category=not-found
  ...
  reproducibility: PATCH /api/v1/items/toggle-status/6a03391356ea778474f53492 using context=admin
- PUT /api/v1/items/update/:id -> controller/itemCategoryController.js#updateCategory | status=404 | category=not-found
  error: Category not found
  reproducibility: PUT /api/v1/items/update/6a03391356ea778474f53492 using context=admin
- POST /api/v1/medical-records/createMedicalRecord -> controller/medicalRecordController.js#createMedicalRecord | status=500 | category=server-bug
  ...
  reproducibility: POST /api/v1/medical-records/createMedicalRecord using context=serviceProvider
- DELETE /api/v1/medical-records/deleteMedicalRecord/:id -> controller/medicalRecordController.js#deleteMedicalRecord | status=404 | category=not-found
  ...
  reproducibility: DELETE /api/v1/medical-records/deleteMedicalRecord/6a03391356ea778474f53492 using context=patient
...
- POST /api/v1/medical-records/shareMedicalRecord/:id/share -> controller/medicalRecordController.js#shareMedicalRecord | status=404 | category=not-found
  error: Medical record not found
  reproducibility: POST /api/v1/medical-records/shareMedicalRecord/6a03391356ea778474f53492/share using context=patient
- PATCH /api/v1/medical-records/updateMedicalRecord/:id -> controller/medicalRecordController.js#updateMedicalRecord | status=404 | category=not-found
  error: Medical record not found
  reproducibility: PATCH /api/v1/medical-records/updateMedicalRecord/6a03391356ea778474f53492 using context=patient
- POST /api/v1/patient/follow/:doctorId -> controller/patientController.js#followDoctor | status=404 | category=not-found
  error: Doctor not found
  reproducibility: POST /api/v1/patient/follow/507f1f77bcf86cd799439011 using context=patient
- GET /api/v1/patient/getById/:patientId -> controller/patientController.js#getPatientById | status=404 | category=not-found
  error: Patient not found
  reproducibility: GET /api/v1/patient/getById/6a031fdc05fb2370df312436 using context=public
...
- DELETE /api/v1/patient/unfollow/:doctorId -> controller/patientController.js#unfollowDoctor | status=400 | category=validation
  ...
  reproducibility: DELETE /api/v1/patient/unfollow/507f1f77bcf86cd799439011 using context=patient
- PATCH /api/v1/patient/updateProfile/:id -> controller/patientController.js#updatePatient | status=404 | category=not-found
  ...
  reproducibility: PATCH /api/v1/patient/updateProfile/6a031fdc05fb2370df312436 using context=patient
...
- PATCH /api/v1/reviews/admin/:id/moderation -> controller/reviewController.js#moderateReview | status=404 | category=not-found
  error: Review not found
  reproducibility: PATCH /api/v1/reviews/admin/6a03391356ea778474f53492/moderation using context=admin
...
- DELETE /api/v1/reviews/deleteReview/:id -> controller/reviewController.js#deleteReview | status=404 | category=not-found
  error: Review not found
  reproducibility: DELETE /api/v1/reviews/deleteReview/6a03391356ea778474f53492 using context=patient
- PATCH /api/v1/reviews/updateReview/:id -> controller/reviewController.js#updateReview | status=404 | category=not-found
  error: Review not found
  reproducibility: PATCH /api/v1/reviews/updateReview/6a03391356ea778474f53492 using context=patient
- GET /api/v1/service/:id/price -> controller/serviceController.js#calculateServicePrice | status=404 | category=not-found
  error: Service not found or inactive
  reproducibility: GET /api/v1/service/6a03391356ea778474f53492/price using context=public
- POST /api/v1/service/:id/restore -> controller/serviceController.js#restoreService | status=404 | category=not-found
  ...
  reproducibility: POST /api/v1/service/6a03391356ea778474f53492/restore using context=admin
- PATCH /api/v1/service/:id/toggle-status -> controller/serviceController.js#toggleServiceStatus | status=404 | category=not-found
  ...
  reproducibility: PATCH /api/v1/service/6a03391356ea778474f53492/toggle-status using context=admin
- GET /api/v1/service/:serviceId/slots -> controller/serviceController.js#getAvailableSlots | status=400 | category=validation
  error: Date is required
  reproducibility: GET /api/v1/service/6a03248b28ee1195704f4539/slots using context=public
...
- POST /api/v1/service/createService -> controller/serviceController.js#createService | status=400 | category=validation
  error: Invalid city IDs: 6a02f3dea924e2b2a433f288
...
- GET /api/v1/service/getServiceById/:id -> controller/serviceController.js#getServiceById | status=404 | category=not-found
  error: Service not found
  reproducibility: GET /api/v1/service/getServiceById/6a03391356ea778474f53492 using context=public
...
- PATCH /api/v1/service/services/:id -> controller/serviceController.js#updateService | status=404 | category=not-found
  error: Service not found
  reproducibility: PATCH /api/v1/service/services/6a03248b28ee1195704f4539 using context=admin
- PATCH /api/v1/serviceProvider/:id/toggle-status -> controller/providerController.js#toggleStatus | status=404 | category=not-found
  ...
  reproducibility: PATCH /api/v1/serviceProvider/6a03391356ea778474f53492/toggle-status using context=admin
...
- GET /api/v1/serviceProvider/service-provider/:id -> controller/providerController.js#getServiceProviderById | status=404 | category=not-found
  error: Service provider not found
  reproducibility: GET /api/v1/serviceProvider/service-provider/6a3a37b3494e41b9dabb4d24 using context=public
- PUT /api/v1/serviceProvider/service-provider/:id -> controller/providerController.js#updateServiceProvider | status=404 | category=not-found
  error: Service provider not found
  reproducibility: PUT /api/v1/serviceProvider/service-provider/6a3a37b3494e41b9dabb4d24 using context=admin
- PATCH /api/v1/serviceProvider/service-provider/:id/workflow -> controller/providerController.js#updateServiceProviderWorkflow | status=400 | category=validation
  ...
  reproducibility: PATCH /api/v1/serviceProvider/service-provider/6a3a37b3494e41b9dabb4d24/workflow using context=admin
...
- GET /api/v1/serviceProvider/service-provider/appointments/:id -> controller/providerController.js#getSingleAppointment | status=404 | category=not-found
  ...
  reproducibility: GET /api/v1/serviceProvider/service-provider/appointments/6a3a37b3494e41b9dabb4d24 using context=admin
- POST /api/v1/socialPost/createPost -> controller/socialmediaController.js#createPost | status=404 | category=not-found
  error: Doctor not found for user: 6a3a37b1494e41b9dabb4d12
...
- PATCH /api/v1/socialPost/posts/:id/hide -> controller/socialmediaController.js#toggleHidePost | status=404 | category=not-found
  ...
  reproducibility: PATCH /api/v1/socialPost/posts/6a3948c8600662c9cfffc39c/hide using context=admin
- POST /api/v1/socialPost/posts/:id/report -> controller/socialmediaController.js#reportPost | status=400 | category=validation
  ...
  reproducibility: POST /api/v1/socialPost/posts/6a3948c8600662c9cfffc39c/report using context=patient
...
- POST /api/v1/socialPost/savePost/:id/toggle -> controller/socialmediaController.js#toggleSavePost | status=404 | category=not-found
  error: Post not found
  reproducibility: POST /api/v1/socialPost/savePost/6a3948c8600662c9cfffc39c/toggle using context=patient
- POST /api/v1/support/addMessageTickets/:id -> controller/supportController.js#addMessage | status=404 | category=not-found
  error: Support ticket not found
  reproducibility: POST /api/v1/support/addMessageTickets/6a03391356ea778474f53492 using context=patient
