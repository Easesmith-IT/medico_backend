...
router.post("/createMedicalRecord", protect("patient", "doctor", "admin", "superadmin", "subadmin"), medicalRecordController.createMedicalRecord);
router.get("/getPatientRecords/:patientId", protect("patient", "doctor", "admin", "superadmin", "subadmin"), medicalRecordController.getPatientRecords);
router.get("/getMyRecords", protect("patient", "doctor", "admin", "superadmin", "subadmin"), medicalRecordController.getMyRecords);
router.patch("/updateMedicalRecord/:id", protect("patient", "doctor", "admin", "superadmin", "subadmin"), medicalRecordController.updateMedicalRecord);
